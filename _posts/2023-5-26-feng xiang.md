...
$$
\boxed{问题：1, 3, 5, 7, 下一个数是什么？}\\

\color{white}{}\\

\color{black} 答案是 \color{red}114514，\color{black}因为有通项公式\\

\color{white}{}\\

\color{black}\boxed{f(x) = \dfrac{18111}{2}x^4 - 90555x^3 + \dfrac{633885}{2}x^2 - 452773x+217331}\\
...
\color{black}f(1) = 1\space\color{red}\sqrt{}\\

\color{black}f(2) = 3\space\color{red}\sqrt{}\\

\color{black}f(3) = 5\space\color{red}\sqrt{}\\

\color{black}f(4) = 7\space\color{red}\sqrt{}\\

\color{black}则 f(5) = 114514。\\
